-- kickstart.init.lua
--
-- TODO: Read and add other todo's, as necessary.
--
-- TODO: If you don't know anything about Lua, I recommend taking some time to read
...
--
-- TODO: The very first thing you should do is to run the command `:Tutor` in
-- Neovim. (If you already know the Neovim basics, you can skip this step.)
--
-- TODO: Next, run AND READ `:help`.
--
-- NOTE: If you experience any errors while trying to install kickstart, run
...
-- vim: tw=80 ts=2 sts=2 sw=2 et ai ff=unix fixeol eol fenc=utf-8 fdm=marker fdl=0 fen fo=jcroqn
