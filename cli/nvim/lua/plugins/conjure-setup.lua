return {
  -- Extend auto completion.
  {
    ...
    -- Adds "conjure" source to blink.cmp in a way that respects LazyVim's configuration.
    opts = function(_, opts)
      opts.sources = opts.sources or {}
      opts.sources.default = opts.sources.default or {}
      table.insert(opts.sources.default, "conjure")

      opts.sources.providers = opts.sources.providers or {}
      opts.sources.providers.conjure = {
        name = "conjure",
